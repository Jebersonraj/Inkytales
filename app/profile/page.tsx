...
export default function ProfilePage() {
    ...
    const userQuotes = [
        { id: "4", quote: "The unexamined life is not worth living.", genre: "Philosophy", author: "Socrates" },
        { id: "5", quote: "All that is gold does not glitter, not all those who wander are lost.", genre: "Fantasy", author: "J.R.R. Tolkien" },
    ]
